		...
		case 479: // 提昇能力值？（str、dex、int、con、wis、cha）
			if (readC() == 1) {
				...
				if (s.toLowerCase().equals("str".toLowerCase())) {
					...
					if (pc.getBaseStr() < Config.BONUS_STATS1) { // TODO
						...
						pc.sendPackets(new S_SystemMessage("力量属性最大值只能到" + Config.BONUS_STATS1 + ",请选择其他能力值。"));// \f1屬性最大值只能到35
					}
				} else if (s.toLowerCase().equals("dex".toLowerCase())) {
					// if(l1pcinstance.get_dex() < 255)
					if (pc.getBaseDex() < Config.BONUS_STATS1) { // TODO
						...
						pc.sendPackets(new S_SystemMessage("敏捷属性最大值只能到" + Config.BONUS_STATS1 + ",请选择其他能力值。")); // \f1屬性最大值只能到35。

					}
				} else if (s.toLowerCase().equals("con".toLowerCase())) {
					// if(l1pcinstance.get_con() < 255)
					if (pc.getBaseCon() < Config.BONUS_STATS1) { // TODO
						...
						pc.sendPackets(new S_SystemMessage("体质属性最大值只能到" + Config.BONUS_STATS1 + ",请选择其他能力值。")); // \f1屬性最大值只能到35。

					}
				} else if (s.toLowerCase().equals("int".toLowerCase())) {
					// if(l1pcinstance.get_int() < 255)
					if (pc.getBaseInt() < Config.BONUS_STATS1) { // TODO
						...
						pc.sendPackets(new S_SystemMessage("智力属性最大值只能到" + Config.BONUS_STATS1 + ",请选择其他能力值。")); // \f1屬性最大值只能到35。

					}
				} else if (s.toLowerCase().equals("wis".toLowerCase())) {
					// if(l1pcinstance.get_wis() < 255)
					if (pc.getBaseWis() < Config.BONUS_STATS1) { // TODO
						...
						pc.sendPackets(new S_SystemMessage("精神属性最大值只能到" + Config.BONUS_STATS1 + ",请选择其他能力值。")); // \f1屬性最大值只能到35。

					}
				} else if (s.toLowerCase().equals("cha".toLowerCase())) {
					// if(l1pcinstance.get_cha() < 255)
					if (pc.getBaseCha() < Config.BONUS_STATS1) { // TODO
						...
						pc.sendPackets(new S_SystemMessage("魅力属性最大值只能到" + Config.BONUS_STATS1 + ",请选择其他能力值。")); // \f1屬性最大值只能到35。
