...
/*
			if (npcId == 45009) {// 测试
			System.out.println(mob.getName()+" 即将生成 该怪物等级为 "+mob.getLevel()//);
					+" 血为 "+mob.getMaxHp() +" 魔为 "+mob.getMaxMp()
					+" 防御 "+mob.getAc() +" 力量 "+mob.getStr()
					+" 敏捷 "+mob.getDex() +" 体质 "+mob.getCon()
					+" 精神 "+mob.getWis() +" 智力 "+mob.getInt()
					+" 魔防 "+mob.getMr());
			}
*/
