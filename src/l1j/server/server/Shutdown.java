...
public class Shutdown extends Thread {
	...
	private static String[] _modeText = { "【经由‘黑盒子’ 关闭伺服器】", "【‘游戏管理员’执行 关闭伺服器 动作】",
			"【‘游戏管理员’执行 重启伺服器 动作】", "【中断动作】" };
	...
	private void countdown() {
		...
		try {
			while (secondsShut > 0) {
				...
				switch (secondsShut) {
				case 240:
					_an.announceToAll("伺服器关闭倒数 4 分钟.");
					break;
				case 180:
					_an.announceToAll("伺服器关闭倒数 3 分钟.");
					break;
				case 120:
					_an.announceToAll("伺服器关闭倒数 2 分钟.");
					break;
				case 60:
					_an.announceToAll("伺服器关闭倒数 1 分钟.");
					break;
				case 30:
					_an.announceToAll("伺服器关闭倒数 30 秒.");
					break;
				case 10:
					_an.announceToAll("伺服器关闭倒数 10 秒.");
					break;
				case 5:
					_an.announceToAll("伺服器关闭倒数 5 秒.");
					break;
				case 4:
					_an.announceToAll("伺服器关闭倒数 4 秒.");
					break;
				case 3:
					_an.announceToAll("伺服器关闭倒数 3 秒.");
					break;
				case 2:
					_an.announceToAll("伺服器关闭倒数 2 秒.");
					break;
				case 1:
					_an.announceToAll("伺服器关闭倒数 1 秒.");
					break;
				}
